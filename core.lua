...
do
	...
	function addon:PLAYER_LOGIN()
		...
		for i = #dataProviderQueue, 1, -1 do
			...
			if data.region == PLAYER_REGION or ns.addonConfig.devMode == true then
		...
		if ns.addonConfig.devMode == true then
...
_G.RaiderIO = {
	...
	--   regionOrNil           = "eu", "us", "kr", "tw", or nil for automatic (default to current region) - only useful when devMode is enable
	--
